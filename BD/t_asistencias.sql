...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2021 a las 00:44:51
...
INSERT INTO `t_asistencias` (`id_t_asistencia`, `cant`, `id_evento`) VALUES
(6, 25, 1);
...
--
ALTER TABLE `t_asistencias`
  MODIFY `id_t_asistencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
