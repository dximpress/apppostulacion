...
$(document).on("click", "#enviar", function (e) {
  ...
  if (long != x) {
    ...
    Swal.fire({
      ...
      html: "Muchas gracias por completar el formulario para la solicitud de Crédito Educativo. <br> Nos contactaremos contigo una vez tengamos una respuesta de Educadores Cooperativa.",
      icon: "info",
      background: '#fff url(assets/media/bg/bg-12.jpg)',
      buttonsStyling: false,
      confirmButtonText: "Ok",
