        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-12 text-center">
              <img src="landings/assets/img/UNIREP-01.png" alt="Image" class="phone-1" data-aos="fade-right" style="width: 30%;">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5" id="comenzar">
          <div class="col-md-12" data-aos="fade-down">
            <h2 class="section-heading">Formulario de postulación</h2>
							...
							<div class="wizard-steps">
								...
								<div class="wizard-step" data-wizard-type="step">
									<div class="wizard-wrapper">
										...
										<div class="wizard-label">
											<h3 class="wizard-title">Enviar postulación</h3>
									...
									<form id="kt_form" class="form"></form>
										...
										<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
											...
											<div class="form-group">
												<label>Estudios de cuarto nivel (maestría): <span class="text-danger">*</span></label>
												...
												<span class="pl-5 spaninfo">
													...
													<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Título, IES y registro de Senescyt.</span>
												</span>
											</div>

											<div class="form-group mt-15">
												<label>Otros estudios de cuarto nivel (diplomados, especializaciones): <span class="text-danger">*</span></label>
												<textarea  class="form-control" name="otrosestudioscuartonivel" id="otrosestudioscuartonivel" cols="15" rows="25" placeholder="..." required="required">
													<?php echo "$otrosestudioscuartonivel"; ?>
												</textarea>
												<span class="pl-5 spaninfo">
													<input type="hidden" class="requerido" name="otrosestudioscuartonivel-req" id="otrosestudioscuartonivel-req" value="<?php if($otrosestudioscuartonivel){ echo "1"; } ?>">
													<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Título, IES y registro de Senescyt.</span>
												</span>
											</div>

											<div class="form-group mt-15">
												<label>Estudios de tercer nivel: <span class="text-danger">*</span></label>
											...
											<div class="form-group mt-15">
												...
												<textarea  class="form-control" name="idiomas" id="idiomas" cols="15" rows="25" placeholder="..." required="required">
													<?php echo "$idiomas"; ?>
												</textarea>
												<span class="pl-5 spaninfo">
													<input type="hidden" class="requerido" name="idiomas-req" id="idiomas-req" value="<?php if($idiomas){ echo "1"; } ?>">
													<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Idioma y nivel de certificación.</span>
												</span>
											</div>
										</div>
										<!--end: Wizard Step 1-->
										...
										<div class="pb-5" data-wizard-type="step-content">
											...
											<div class="row">
												<div class="col-xl-12">
													<!--begin::Input-->
													<div class="form-group">
														<label>Institución o Empresa: <span class="text-danger">*</span></label>
											...
											<div class="row">
												<div class="col-xl-12">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control requerido" name="direccionempresa" id="direccionempresa" placeholder="..." value="<?php echo "$direccionempresa"; ?>" />
													</div>
													<!--end::Input-->
												</div>
											</div>
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														...
														<input type="text" class="form-control requerido" name="telefonoempresa" id="telefonoempresa" placeholder="..." value="<?php echo "$telefonoempresa"; ?>" />
													</div>
												</div>
												<div class="col-xl-6">
													<div class="form-group">
														<label style="margin-bottom: 10px;">Tipo de Institución o Empresa: <span class="text-danger">*</span></label><br>
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="form-group mt-15">
														<label>Descripción de la labor que desempeña: <span class="text-danger">*</span></label>
														<textarea  class="form-control" name="laborempresa" id="laborempresa" cols="15" rows="25" placeholder="..." required="required">
															<?php echo "$laborempresa"; ?>
														</textarea>
														<input type="hidden" class="requerido" name="laborempresa-req" id="laborempresa-req" value="<?php if($laborempresa){ echo "1"; } ?>">
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="form-group mt-15">
														<label>Capacitaciones (últimos 5 años): <span class="text-danger">*</span></label>
														<textarea  class="form-control" name="capacitaciones" id="capacitaciones" cols="15" rows="25" placeholder="..." required="required">
															<?php echo "$capacitaciones"; ?>
														</textarea>
														<span class="pl-5 spaninfo">
															<input type="hidden" class="requerido" name="capacitaciones-req" id="capacitaciones-req" value="<?php if($capacitaciones){ echo "1"; } ?>">
															<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Tema, duración, institución y fecha.</span>
														</span>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="form-group mt-15">
														<label>Experiencia en docencia: <span class="text-danger">*</span></label>
														...
														<span class="pl-5 spaninfo">
															...
															<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Institución, nivel, cargo, fecha de inicio y fecha de fin.</span>
														</span>
													</div>
												</div>
											</div>	
										...
										<div class="pb-5" data-wizard-type="step-content">
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="form-group mt-15">
														<label>Publicaciones en revistas: <span class="text-danger">*</span></label>
														...
														<span class="pl-5 spaninfo">
															...
															<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Tema, año de publicación, medio y enlaces.</span>
														</span>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="form-group mt-15">
														<label>Libros o capítulos de libros: <span class="text-danger">*</span></label>
														...
														<span class="pl-5 spaninfo">
															...
															<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Tema, editorial, año de publicación, ISBN.</span>
														</span>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="form-group mt-15">
														<label>Participación como ponente o conferencista en eventos académicos: <span class="text-danger">*</span></label>
														<textarea  class="form-control" name="participacioneventos" id="participacioneventos" cols="15" rows="25" placeholder="..." required="required">
															<?php echo "$participacioneventos"; ?>
														</textarea>
														<span class="pl-5 spaninfo">
															<input type="hidden" class="requerido" name="participacioneventos-req" id="participacioneventos-req" value="<?php if($participacioneventos){ echo "1"; } ?>">
															<i class="bi bi-info-circle"></i> <span class="form-text text-muted">Nombre del evento, tema y año de participación.</span>
														</span>
													</div>
												</div>
											</div>
															...
															<div class="row fileupload-buttonbar">
													          <div class="col-lg-12">
													          	<div class="row">
													          		<div class="col-lg-5">
													          			<label class="fs-14">
															          		2- Copia de título de grado. <span class="text-danger">*</span> <br>
															          	</label>
													          ...
													          <div class="col-lg-12">
														            ...
														            <?php 
														              $stylecopiatitulo = 0;
														            	if($copiatitulo == ''){
														            		$stylecopiatitulo = "display: initial";
														             	}else{
														             		$stylecopiatitulo = "display: none";
														             	}; 
														            ?>
														            <span class="btn btn-primary btn-sm fileinput-button" id="copiatitulo" style="<?php echo $stylecopiatitulo; ?>">
														              <i class="bi bi-plus"></i>
														              <span>AÑADIR ARCHIVO</span>
														              <input type="file" name="files[]" multiple />
														            </span>
										...
										<div class="pb-5" data-wizard-type="step-content">
											...
											<div class="row">
												...
												<div class="col-xl-12" style="padding-top: 5px">
													<div class="form-group">
														<div class="form-check form-check-inline">
														  <input class="form-check-input" type="radio" name="comonosconocio" id="comonosconocio1" value="correo" <?php if($comonosconocio == 'correo'){echo "checked";} ?> >
														  <label class="form-check-label" for="comonosconocio1" style="margin-top: 0">Correo electrónico</label>
														</div>
														<div class="form-check form-check-inline">
														  <input class="form-check-input" type="radio" name="comonosconocio" id="comonosconocio2" value="redes" <?php if($comonosconocio == 'redes'){echo "checked";} ?> >
														  <label class="form-check-label" for="comonosconocio2" style="margin-top: 0">Redes sociales</label>
														</div>
														<div class="form-check form-check-inline">
														  <input class="form-check-input" type="radio" name="comonosconocio" id="comonosconocio3" value="sitioweb" <?php if($comonosconocio == 'sitioweb'){echo "checked";} ?> >
														  <label class="form-check-label" for="comonosconocio3" style="margin-top: 0">Sitio web: Red Ecuatoriana de Pedagogía</label>
														</div>
														<div class="form-check form-check-inline">
														  <input class="form-check-input" type="radio" name="comonosconocio" id="comonosconocio4" value="referencia" <?php if($comonosconocio == 'referencia'){echo "checked";} ?> >
														  <label class="form-check-label" for="comonosconocio4" style="margin-top: 0">Referencia personal</label>
														</div>
													</div>
													<input type="hidden" class="requerido" name="comonosconocio-req" id="comonosconocio-req" value="<?php if($comonosconocio){ echo "1"; } ?>">
												</div>
											</div>
										</div>
										<!--end: Wizard Step 6-->
