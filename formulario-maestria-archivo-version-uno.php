...
<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
	...
	<div class="form-group">
		<label>Estudios de tercer nivel (se exceptúan títulos de tecnología).<span class="text-danger">*</span></label><br>
	...
	<div class="form-group mt-15">
		<label>Estudios de cuarto nivel - maestría (opcional).</label><br>
		...
		<span class="pl-5 spaninfo">
			...
			<input type="hidden" class="" name="estudioscuartonivel-req" id="estudioscuartonivel-req" value="<?php if($estudioscuartonivel){ echo "1"; } ?>">
			
		</span>
	</div>

	<div class="form-group mt-15">
		<label>Idiomas (opcional).</label><br>
...
<div class="pb-5" data-wizard-type="step-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="form-group mt-15">
				<label>Experiencia laboral (opcional). </label><br>
					...
					<div class="row fileupload-buttonbar">
			          <div class="col-lg-12">
			          	<div class="row">
			          		<div class="col-lg-5">
			          			<label class="fs-14">
					          		2- Copia de títulos de tercer nivel de grado universitario  (se exceptúan títulos de tecnología). <span class="text-danger">*</span> <br>
					          	</label>
...
-->
	...
	<div class="row">
		<div class="col-xl-12">
					...
					<div class="row fileupload-buttonbar">
			          <div class="col-lg-12">
			          	<div class="row">
			          		<div class="col-lg-5">
			          			<label class="fs-14">
					          		3- Copia de títulos de cuarto nivel de grado universitario (opcional). <br>
					          	</label>
			...
			<input type="hidden" class="" name="copiatitulocuartonivel-req" id="copiatitulocuartonivel-req" value="<?php if($copiatitulocuartonivel){ echo "1"; } ?>">
