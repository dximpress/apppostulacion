        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-12 text-center">
              ...
              <h1 data-aos="fade-right" style="color: #FFFFFF;">¡Felicidades! </h1> 
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 mb-4 mb-md-0 text-center">
          <h4 style="color: #043564"> El envío de tu postulación se ha realizado correctamente.</h4>
              <h4 style="color: #043564">Una vez analizada la información, nuestro departamento académico se comunicará contigo para el siguiente paso.</h4>
        </div>
      </div>
