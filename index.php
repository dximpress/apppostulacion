...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading" style="background-image: url('assets/media/bg/fondo_login.jpg');">
		<!--begin::Main-->
		<div class="d-flex flex-column flex-root">
						...
						<div class="row">
							<div class="col-lg-6 offset-md-3">
								...
								<div class=" flex-center text-center mb-15">
									<img src="assets/media/logos/logo-redp-II.png" class="" alt=""  style="width: 70%" />
								<!--
									<div class="logos">
										<img src="assets/media/logos/logos-colaboracion.png" class="" alt=""  style="width: 50%" />
									</div>
								-->
									
									<br>
									<h4>Sistema de postulaciones</h4>
								</div>
								<!--end::Login Header-->
								...
								<div class="login-signin">
									<form role="form" id="login" name="form_ingreso" method="post" action="<?php echo $loginFormAction; ?>">
										...
										<button type="submit" class="btn btn-primary btn-sm font-weight-bold">INGRESAR</button><br><br>
			...
			<!--end::Login-->
			<span><a href="wpaccess.php" style="position: relative; float: right; right: 15px; bottom: 5px">admin</a></span>
		</div>
		            ...
		            <div class="modal-body">
		              ...
		              <div class="row">
		              	<div class="col-md-3">
		              		<div class="form-group">
												...
												<span class="text-danger">*</span></label>
												<input type="text" name="cedula" id="cedula" class="form-control " placeholder="..." onkeypress="return valida(event)" onchange="consultarCedula(this)" required="required">
											...
											<div class="col-xl-12" style="padding-top: 5px">
												<div class="form-group">
													<div class="form-check form-check-inline">
													  ...
													  <label class="form-check-label" for="comonosconocio1" style="margin-top: 0">Correo</label>
													</div>
													<div class="form-check form-check-inline">
													...
													<div class="form-check form-check-inline">
													  ...
													  <label class="form-check-label" for="comonosconocio3" style="margin-top: 0">Sitio web</label>
													</div>
													<div class="form-check form-check-inline">
		              ...
		              <div class="row">
		              	<div class="col-md-12 alert alert-primary">
		              		<p>
		              			<span class="text-danger"><i class="fa fa-info-circle text-white"></i></span> Una vez completado el registro podrá acceder con su cédula o pasaporte para poder postular por uno de nuestros programas.
		              		</p>
		              	</div>
		              </div>
		...
		<script src="assets/js/pages/custom/login/login-general.js?ver1.14"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>